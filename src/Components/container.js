        ...
        <main className='Container'>
            <div className='Head-Container'>
                <div className='Date-nav'>
                    <div className='dateMonth padding-left' onClick={monthClick}>{month}</div>
                    <div className='dateYear padding-right' onClick={yearClick}>{year}</div>
                </div>
            ...
            <div className='Days'>
                {titles.length > 0 ? titles.map((el, i) =>
